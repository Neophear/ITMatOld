...
<table class="editorTable">
    <tr>
        <td>
            ...
            <input type="button" class="editorButton" value="Url" name="url" onclick="javascript: wrapSelection('[url]', '[/url]');"
    ...
    <tr>
        <td>
            <input type="text" name="helpbox" size="67" class="editorHelpbox" readonly="readonly" />
        </td>
    </tr>
    <tr>
        <td>
